               ...
               <span className="Quote_service_container_title" >Take few steps before <br/>perfect clean place</span><br/><br/><br/><br/>
                ...
                <Grid container  justify="center" style={{padding:"10px"}}>
                    <Grid item xs={12} sm={6} md={4} lg={3} style={{textAlign:'center'}}>
                        ...
                        >
                            <div style={{height:"100px"}}>
                                    <img src="./static/file/day icon.png"   width="100px" height="100px" alt="DayCare" />
                            </div>  
                            <div  style={{height:"50px"}}>
                    ...
                    <Grid item xs={12} sm={6} md={4} lg={3} style={{textAlign:'center'}}>
                        ...
                        >
                            <div style={{height:"100px"}}>
                                    <img src="./static/file/home icon.png"   width="100px" height="100px"  alt="Home/Apartment" />
                            </div>  
                            <div  style={{height:"50px"}}>
                    ...
                    <Grid item xs={12} sm={6} md={4} lg={3} style={{textAlign:'center'}}>
                        ...
                        >
                            <div style={{height:"100px"}}>
                                    <img src="./static/file/office.jpg"     width="100px" height="100px"alt="Office" />
                            </div>  
                            <div  style={{height:"50px"}}>
                    ...
                    <Grid item xs={12} sm={6} md={4} lg={3} style={{textAlign:'center'}}>
                        ...
                        >
                            <div style={{height:"100px"}}>
                                    <img src="./static/file/construction icon.png"   width="100px" height="100px"  alt="Construction" />
                            </div>  
                            <div  style={{height:"50px"}}>
                    ...
                    <Grid item xs={12} sm={6} md={4} lg={3} style={{textAlign:'center'}}>
                        ...
                        >
                            <div style={{height:"100px"}}>
                                    <img src="./static/file/carpet icon.png"   width="100px" height="100px" alt="Carpet" />
                            </div>  
                            <div  style={{height:"50px"}}>
                    ...
                    <Grid item xs={12} sm={6} md={4} lg={3} style={{textAlign:'center'}}>
                        ...
                        >
                            <div style={{height:"100px"}}>
                                    <img src="./static/file/movein icon.png"  width="100px" height="100px" alt="Move in/out" />
                            </div>  
                            <div  style={{height:"50px"}}>
                    ...
                    <Grid item xs={12} sm={6} md={4} lg={3} style={{textAlign:'center'}}>
                        ...
                        >
                            <div style={{height:"100px"}}>
                                    <img src="./static/file/airbon icon.png"   width="100px" height="100px" alt="AIRBNB" />
                            </div>  
                            <div  style={{height:"50px"}}>
